...
Compare the typeset output side-by-side with the input document. hhhhhhhhhhhhhhhhhhhhhhhhh
sssssssssss
...
Use the ``quote'' and ``quotation'' environments for typesetting quoted ssssnakes ibn the sky.. there is a potato int hte sky
